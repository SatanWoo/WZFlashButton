...
- (void)viewDidLoad
{
    ...
    WZFlashButton *outerRectangleFlashButton = [[WZFlashButton alloc] initWithFrame:CGRectMake(180, 50, 100, 60)];
    outerRectangleFlashButton.buttonType = WZFlashButtonTypeOuter;
    [outerRectangleFlashButton setText:@"Hello World!" withTextColor:[UIColor purpleColor]];
